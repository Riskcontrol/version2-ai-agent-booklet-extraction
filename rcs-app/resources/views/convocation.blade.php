...
<body class="bg-green-50 text-gray-900 font-sans">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    <nav class="flex gap-2">
                        <a href="{{ route('dashboard') }}" class="text-sm px-3 py-2 rounded-lg bg-[#0a2912] text-white transition font-medium">Convocation</a>
    ...
    <main class="max-w-5xl mx-auto px-4 py-6">
            ...
            <div class="bg-white border border-gray-200 rounded-xl p-4 shadow-sm md:col-span-3">
                <div class="flex items-start justify-between gap-4">
                    <div>
                        ...
                        <p class="text-sm text-gray-600 mt-1">Credits are billed and fulfilled by Google Cloud. Uploads here reserve credits before processing starts.</p>
        ...
        <section class="bg-white border border-gray-200 rounded-xl p-4 shadow-sm mb-6">
            ...
            <form id="uploadForm" class="space-y-3" method="POST" action="javascript:void(0);" onsubmit="return false;" data-max-upload-mb="{{ $effectiveUploadLimitMb }}">
                ...
                <div class="rounded-lg bg-lime-50 border border-lime-100 p-3 text-sm text-gray-700">
                    Workflow key control is enforced by Google Cloud. This portal sends workload metadata only, and processing runs only when partner authorization returns the approved paid tier.
                </div>
        ...
        <input id="filter_extraction_type" type="hidden" value="convocation" />
